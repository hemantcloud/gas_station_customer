...
import 'package:gas_station_customer/models/login_model.dart';
...
class _LoginState extends State<Login> {
  ...
  Future getLatLong() async {
    ...
    print('lat(login) : ---------' + locationData!.latitude.toString());
    print('long(login) : ---------' + locationData!.longitude.toString());
    setState(() {});
  }
  getTimeZone() async{
  ...
  Future<void> loginApi(BuildContext context) async {
    ...
    request['longitude'] = long.toString();
