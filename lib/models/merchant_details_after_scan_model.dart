class MerchantDetailsAfterScanModel {
  bool? status;
  String? message;
  MerchantData? data;

  MerchantDetailsAfterScanModel({this.status, this.message, this.data});

  MerchantDetailsAfterScanModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
